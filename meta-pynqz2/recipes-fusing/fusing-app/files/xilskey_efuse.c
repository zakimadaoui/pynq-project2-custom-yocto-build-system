...
int main()
{
...
#else
	xil_printf("Did not write PS Efuse, XSK_WRITE_EFUSES=FALSE\n\r");
#endif
	...
	#include"sleep.h"
	printf("sleep for 30 secs.... (1/5)\r\n");
	printf("AR_RST      MIO12 -> TMS (1) \r\n");
	printf("MODE2 (3.1) MIO4  -> TDI (2) \r\n");
	printf("MODE3 (2.2) MIO2  -> TDO (3) \r\n");
	printf("MODE4 (4.2) MIO6  -> TCK (4) \r\n");
	sleep(30);
	printf("sleep for 30 secs.... (2/5)\r\n");
	sleep(30);
	printf("sleep for 30 secs.... (3/5)\r\n");
	sleep(30);
	printf("sleep for 30 secs.... (4/5)\r\n");
	sleep(30);
	printf("sleep for 30 secs.... (5/5)\r\n");
	sleep(30);
...
#else
	xil_printf("Did not program PL Efuse, XSK_WRITE_EFUSES=FALSE\n\r");
#endif
...
#include"sleep.h"
	...
	{
		sleep(5);
		xil_printf("Fusing app finished, please poweroff\r\n");
	}
