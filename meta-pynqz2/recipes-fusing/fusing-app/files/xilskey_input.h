...
#define     XSK_WRITE_EFUSES					FALSE /** If TRUE efuses will be blown according to the configuration 
...
//  AR_RST      MIO12 -> TMS (1) ???? some risk of current back to 1.1....
//  MODE2 (3.1) MIO4  -> TDI (2) 
//  MODE3 (2.2) MIO2  -> TDO (3) 
//  MODE4 (4.2) MIO6  -> TCK (4) 
//  MUX SEL -> 13 Unconnected 

#define		XSK_EFUSEPL_MIO_JTAG_TDI		(4)  /**< JTAG MIO pin for TDI */
#define		XSK_EFUSEPL_MIO_JTAG_TDO		(2)  /**< JTAG MIO pin for TDO */
#define		XSK_EFUSEPL_MIO_JTAG_TCK		(6)  /**< JTAG MIO pin for TCK */
#define		XSK_EFUSEPL_MIO_JTAG_TMS		(12) /**< JTAG MIO pin for TMS */
#define		XSK_EFUSEPL_MIO_JTAG_MUX_SELECT	(13) /**< JTAG MIO pin for
												 * MUX selection line
												 */
/**
 *
...
#define XSK_EFUSEPL_AXI_GPIO_DEVICE_ID	XPAR_AXI_GPIO_0_DEVICE_ID
#else
#define XSK_EFUSEPL_AXI_GPIO_DEVICE_ID	XPAR_XGPIOPS_0_BASEADDR
#endif
